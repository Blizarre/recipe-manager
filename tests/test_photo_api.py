...
class TestPhotoEndpoints:
    ...
    def test_delete_photo(self, client_with_temp_dir):
        ...
        upload_response = client_with_temp_dir.post("/api/photos/test-recipe.md", files=files)
    ...
    def test_upload_replace_existing_photo(self, client_with_temp_dir):
        ...
        response1 = client_with_temp_dir.post("/api/photos/test-recipe.md", files=files1)
        ...
        response2 = client_with_temp_dir.post("/api/photos/test-recipe.md", files=files2)
