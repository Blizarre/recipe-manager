...
class FileSystemManager:
    ...
    async def write_file(self, path: str, content: str) -> Dict[str, str]:
        ...
        try:
            ...
            return {"message": "File saved successfully", "path": str(file_path.relative_to(self.base_dir))}
        except Exception as e:
    ...
    async def create_directory(self, path: str) -> Dict[str, str]:
        ...
        try:
            ...
            return {"message": "Directory created successfully", "path": str(dir_path.relative_to(self.base_dir))}
        except Exception as e:
